...
def collect_data(num_steps):
	...
	# Call option
	# S0 = 100
	# V_known = european_option_price(S0, K, T, r, sigma, 'call')
	...
	# prices = [american_option_price(S0, K, T, r, sigma, "call", num_paths=100000, num_steps=num_steps) for _ in range(repeat)]
...
if __name__ == "__main__": # Collect prices_avg, run_times, rel_errs, std_errs with varying num_steps
	...
	with open("gustafsson_results/call_S=100_4bases.csv", "w", newline="") as f:
